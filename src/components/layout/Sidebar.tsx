      ...
      `}>
                ...
                <div className="flex items-center justify-between p-4 border-b border-gray-200">
                    <div className="flex items-center space-x-3">
                        ...
                        <span className={`font-semibold text-black transition-opacity duration-300 ${isCollapsed ? 'opacity-0 w-0 overflow-hidden' : 'opacity-100'}`}>
                            Glynac
                        </span>
                    </div>
                    ...
                    >
                        <svg className={`w-5 h-5 text-black transition-transform duration-300 ${isCollapsed ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <nav className="p-4 space-y-2">
                        {navItems.map((item) => {
                            ...
                            return (
                                ...
                                >
                                    <Icon className="w-5 h-5 mr-3 text-black flex-shrink-0" />
