...
export default function OperationsDashboard() {
  ...
  const renderBottleneck = (bottle: WorkflowBottleneck) => {
    ...
    return (
      <div key={bottle.id} className={`p-4 sm:p-6 rounded-2xl  border-l-4 ${bottle.color} shadow-md hover:shadow-lg transition-all duration-300`}>
  ...
  const renderServiceDelivery = (service: ServiceDeliveryStandard) => (
    <div key = {service.id} className="p-4 lg:p-6 rounded-2xl bg-gradient-to-br from-white to-gray-50 border border-gray-200/50 shadow-md hover:shadow-lg transition-all duration-300">
      <div className="flex justify-between items-center mb-3">
