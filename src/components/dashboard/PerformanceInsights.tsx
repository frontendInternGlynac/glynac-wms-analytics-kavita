    ...
    <div className="bg-white rounded-lg border border-gray-200 p-6 shadow-sm h-full">
      ...
      <div className="space-y-4">
        ...
        <div className="bg-green-50 rounded-lg p-4">
          ...
          <p className="text-xs text-gray-500">15% above team average</p>
        </div>
        ...
        <div className="bg-blue-50 rounded-lg p-4">
          ...
          <p className="text-xs text-gray-500">Conversion effectiveness</p>
        </div>
        ...
        <div className="bg-purple-50 rounded-lg p-4">
          <div className="flex justify-between items-start mb-1">
            ...
            <span className="text-lg font-bold text-purple-600">3.7 days</span>
          </div>
          <p className="text-xs text-gray-500">2.3 days faster than target</p>
        </div>
        ...
        <div className="bg-indigo-50 rounded-lg p-4">
          ...
          <p className="text-xs text-gray-500">Based on all touchpoints</p>
        </div>
      </div>
    </div>
  );
