...
const AdvisorPerformance = () => {
    ...
    return (
        <div className="space-y-8">
            ...
            {/* Charts Section */}
            <div>
                <h3 className="text-lg font-semibold text-black mb-4">Performance Analytics</h3>
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">

                    {/* AUM Growth Chart */}
                    <div className="bg-white rounded-lg shadow p-6">
                        <h4 className="text-base font-semibold text-black mb-4">AUM Growth Trend</h4>
                        <ResponsiveContainer width="100%" height={250}>
                            <AreaChart data={monthlyGrowthData} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
                                ...
                                />
                                <Tooltip
                                    formatter={(value, name) => [`$${value}B`, 'AUM']}
                    ...
                    <div className="bg-white rounded-lg shadow p-6">
                        <h4 className="text-base font-semibold text-black mb-4">Advisor Performance Comparison</h4>
                        <ResponsiveContainer width="100%" height={250}>
            ...
            {/* Top Advisors Table */}
            <div>
                <h3 className="text-lg font-semibold text-black mb-4">Top Performing Advisors</h3>
                <div className="bg-white rounded-lg shadow">
                    <div className="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
                        <h4 className="text-base font-semibold text-black">Performance Rankings</h4>
                        <button className="text-sm text-black hover:text-black font-medium">View All Advisors →</button>
                    </div>
                        ...
                        <table className="min-w-full divide-y divide-gray-200">
                            ...
                            <tbody className="bg-white divide-y divide-gray-200">
                                {topAdvisors.map((advisor, index) => (
                                    <tr key={advisor.name} className="hover:bg-white cursor-pointer">
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <div className="flex items-center">
                                                ...
                                                <div className="ml-4">
                                                    <div className="text-sm font-medium text-black">{advisor.name}</div>
                                                    <div className="text-sm text-black">{advisor.title}</div>
                                                </div>
                                            </div>
                                        </td>
            ...
            <div>
                <h3 className="text-lg font-semibold text-black mb-4">Monthly Growth Trends</h3>
                <div className="bg-white rounded-lg shadow p-6">
                    <h4 className="text-base font-semibold text-black mb-4">Clients & Revenue Growth</h4>
